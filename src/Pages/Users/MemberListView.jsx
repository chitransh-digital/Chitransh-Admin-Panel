...
const MemberList = () => {
  const { familyID, members } = useLocation().state;
      ...
      <div className="w-full">
        <div className="w-full mt-24">
          <div className=" flex justify-between">
            ...
            <Link to="/addMember" state={{familyID}}>
  ...
  return <MemberView setMemberVariant={setMemberVariant} displayMember={displayMember} familyID={familyID} />;
};
